...
-- CreateEnum
CREATE TYPE "NewsType" AS ENUM ('MEETING_NOTES', 'ANNOUNCEMENTS', 'EVENTS', 'PRESS');
...
CREATE TABLE "News" (
    ...
    "featuredImage" TEXT,
    "type" "NewsType" NOT NULL DEFAULT 'ANNOUNCEMENTS',
    "author" TEXT,
...
-- CreateIndex
CREATE INDEX "Blog_tag_idx" ON "Blog"("tag");
